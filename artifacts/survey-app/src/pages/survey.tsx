...
export default function Survey() {
  ...
  // Autofocus the "Other" input when it becomes visible
  useEffect(() => {
  ...
  const submitMutation = useSubmitSurvey({
    mutation: {
      ...
      onError: (error) => {
        setSubmitError(error?.error?.error || "Failed to submit survey. Please try again.");
        window.scrollTo({ top: 0, behavior: 'smooth' });
      }
    }
  });
  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto w-full">
        ...
        {submitError && (
          <div className="mb-8 p-4 bg-destructive/10 border border-destructive/20 text-destructive rounded-xl flex items-start gap-3">
            <div className="mt-0.5">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinelinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>
            </div>
            <div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-10 bg-card p-6 sm:p-10 rounded-3xl border border-border shadow-sm">
          
          {/* Q1: Text Input */}
          <div className="space-y-3">
            <label htmlFor="after_class_activity" className="block font-semibold text-foreground text-lg">
              1. What do you usually do after classes? <span className="text-destructive">*</span>
            </label>
            <input
            ...
            />
            {errors.after_class_activity && (
              <p id="q1-error" className="text-destructive text-sm font-medium animate-in fade-in slide-in-from-top-1">
          ...
          <div className="space-y-3">
            <label htmlFor="state" className="block font-semibold text-foreground text-lg">
              2. What state are you from? <span className="text-destructive">*</span>
            </label>
            ...
            {errors.state && (
              <p id="q2-error" className="text-destructive text-sm font-medium animate-in fade-in slide-in-from-top-1">
          ...
          <div className="space-y-4">
            <label className="block font-semibold text-foreground text-lg">
          ...
          <div className="space-y-4">
            <label className="block font-semibold text-foreground text-lg">
              4. What activities do you enjoy? (Check all that apply) <span className="text-destructive">*</span>
            </label>
            <div className="grid gap-3 sm:grid-cols-2">
              <Controller
                name="activities"
                ...
                >
                  <input
                    ...
                    ref={(e) => {
                      ...
                      // @ts-ignore - merge refs to allow autofocus logic to work alongside RHF
                  ...
                  />
                  {errors.other_activity && (
                    <p className="text-destructive text-sm font-medium mt-2 animate-in fade-in">
          ...
          <div className="space-y-3">
            <label htmlFor="study_hours" className="block font-semibold text-foreground text-lg">
              5. How many hours do you spend studying per week? <span className="text-destructive">*</span>
            </label>
            <div className="relative">
              <select
          ...
          <div className="space-y-4">
            <label className="block font-semibold text-foreground text-lg">
              6. Do you prefer studying alone or with others? <span className="text-destructive">*</span>
            </label>
